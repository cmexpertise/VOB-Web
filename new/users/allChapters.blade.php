...
@php
  ...
  if($language == 'ko'){
    $video = ($chapters[0]->korean_video != null) ? $chapters[0]->korean_video : $chapters[0]->video;
  }elseif ($language == 'tl') {
    $video = ($chapters[0]->filipino_video != null) ? $chapters[0]->filipino_video : $chapters[0]->video;
  }elseif ($language == 'pt') {
    $video = ($chapters[0]->portuguese_video != null )? $chapters[0]->portuguese_video: $chapters[0]->video;
  }elseif ($language == 'es') {
    $video = ($chapters[0]->spanish_video != null)?$chapters[0]->spanish_video : $chapters[0]->video;
  }else {
...
<section class="video-wrapper">
    <div class="container">
        ...
        <div class="row">
            ...
            @php
              if($language == 'ko'){
                $chapter_video = ($chapter->korean_video != null) ? $chapter->korean_video : $chapter->video;
              }elseif ($language == 'tl') {
                $chapter_video = ($chapter->filipino_video != null ) ? $chapter->filipino_video : $chapter->video;
              }elseif ($language == 'pt') {
                $chapter_video = ($chapter->portuguese_video != null ) ? $chapter->portuguese_video : $chapter->video;
              }elseif ($language == 'es') {
                $chapter_video = ($chapter->spanish_video != null) ? $chapter->spanish_video : $chapter->video;
              }else {
