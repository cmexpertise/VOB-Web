...
<section class="banner-wrapper">
    ...
    <div class="container">
        <div class="banner-content">
            ...
            <div>
                <h4 class="text-center app-store-title">Download App</h4>
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 mb-lg-0 mb-md-4 mb-sm-4">
                <div class="about-img">
                    <img src="{{ asset('assets/user/') }}/img/home/about-img.png" alt="about-img">
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="book-slider owl-carousel owl-theme">
                @foreach ($quotes as $quote )
                    <div class="item ">
                        <a href="{{asset("storage/".$quote->image)}}" class="image-popup-vertical-fit">
                ...
                <div class="col-lg-6">
                    <form action="{{route('payfees')}}" method="post">
                        ...
                        <div class="plan-card">
                            ...
                            <input type="hidden" name="type" value="BASIC" class="sr-only" />
                            <button type="submit" class="cmn-btn wow fadeInLeft" data-wow-duration="4s" data-wow-delay="0" data-wow-offset="0" id="monthlySubscription" name="monthly">Buy Now</button>
                            {{-- <a href="#" type="button" class="cmn-btn wow fadeInRight" data-wow-duration="4s" data-wow-delay="0" data-wow-offset="0">Buy Now</a> --}}
                        </div>
                    </form>
                </div>
            </div>
