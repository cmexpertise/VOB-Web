...
<section class="section">
    <div class="text-end">
        <button type="button" id="click-btn" class="btn btn-primary">Add Postcard</button>
    </div>
    <div class="form-slide">
        <div class="d-flex justify-content-between mt-5"><h2>Postcard Form</h2>
        ...
        <div class="row edit_form"> 
            ...
            <form class="add_postcard" name="add_postcard" method="POST" id="add_postcard" novalidate action="{{route('postcards.add')}}" enctype="multipart/form-data">
                @csrf
                <div class="old_post_card">
                    <div class="row g-3">
                        <div class="col-md-2">
                    ...
                    <div class="row g-3">
                        <div class="col-md-3">
                            ...
                            <input id="upload" onchange="preview_image();" type="file" class="form-control image" name="image[]">
                        </div>
                    </div>
                </div>
                <div class="row g-3">
...
$(document).ready(function() {   
    $('#add_postcard').validate({
        ...
        messages: {
            ...
            'name[]': {
                required: "Please Enter English Postcard Name"
            },
            'korean_name[]': {
                required: "Please Enter Korean Postcard Name"
            },
            'spanish_name[]': {
                required: "Please Enter Spanish Postcard Name"
            },
            'portuguese_name[]': {
                required: "Please Enter Portuguese Postcard Name"
            },
            'filipino_name[]': {
                required: "Please Enter Filipino Postcard Name"
            },
        }
    });
    filter();
