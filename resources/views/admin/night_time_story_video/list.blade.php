...
<section class="section">
    <div class="text-end">
        <button type="button" id="click-btn" class="btn btn-primary">Add Night Time Story Video</button>
    </div>
    <div class="form-slide">
        <div class="d-flex justify-content-between mt-5"><h2>Night Time Story Video Form</h2>
        ...
        <div class="row edit_form"> 
            ...
            <form class="add_form" name="add_form" method="POST" id="add_form" novalidate action="{{route('nighttimestories.add_video')}}" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="story_id" value="{{$story}}" >
                <input type="hidden" name="story_name" value="{{$name}}" >
                <div class="row g-3">
                    <div class="row g-3">
                        <div class="col-md-2">
    ...
    <div class="text-end">
        <a href="{{route('nighttimestories')}}" class="btn btn-dark save-btn">Back</a>
    </div>
</section>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Delete Night Time Story Video</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
            <i class="bi bi-x-circle"></i>
          </button>
        </div>
        <div class="modal-body">
          <p class="pt-3">Are you sure you want to delete this Night Time Story Video ?</p>
        </div>
...
$(document).ready(function() {
    ...
    $('#add_form').validate({
        ...
        messages: {
            ...
            'video': {
                required: "Please Enter English Audio Link"
            },
            'description': {
...
$(document).on('click','.deleteInspirationVideo',function(e){
    var id = $(this).data('id');
    $('.deleteUrl').attr('href','{{route("nighttimestories.delete_video", ["id" => ""]) }}'+id);
})
...
$(document).on('click','.edit',function(e){
    ...
    $.ajax({
        type : 'POST',
        url  : "{{(route('nighttimestories.edit_video'))}}",
