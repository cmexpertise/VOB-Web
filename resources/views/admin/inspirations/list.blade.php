...
<section class="section">
    ...
    <div class="form-slide">
        ...
        <div class="row edit_form"> 
            ...
            <form class="" name="add_form" method="POST" id="add_form" novalidate action="{{route('inspirations.add')}}" enctype="multipart/form-data">
                @csrf
                <div class="row g-3">
                    <div class="row g-3">
                        <div class="col-md-2">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Delete Inspiration</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
            <i class="bi bi-x-circle"></i>
          </button>
        </div>
        <div class="modal-body">
          <p class="pt-3">Are you sure you want to delete this Inspiration ?</p>
        </div>
...
$(document).on('click','.deleteInspiration',function(e){
    var id = $(this).data('id');
    $('.deleteUrl').attr('href','{{route("inspirations.delete", ["id" => ""]) }}'+id);
})
