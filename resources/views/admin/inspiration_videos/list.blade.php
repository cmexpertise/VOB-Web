...
<section class="section">
    <div class="text-end">
        <button type="button" id="click-btn" class="btn btn-primary">Add Meditation Videos</button>
        
    </div>
    <div class="form-slide">
        <div class="d-flex justify-content-between mt-5"><h2>Meditation Videos Form</h2>
        ...
        <div class="row edit_form"> 
            ...
            <form class="add_form" name="add_form" method="POST" id="add_form" novalidate action="{{route('inspirations.add_video')}}" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="inspiration_id" value="{{$inspiration}}" >
                <input type="hidden" name="inspiration_name" value="{{$name}}" >
                <div class="row g-3">
                    <div class="row g-3">
                        <div class="col-md-2">
    ...
    <div class="text-end">
        <a href="{{route('inspirations')}}" class="btn btn-dark save-btn">Back</a>
    </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Delete Inspiration Video</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
            <i class="bi bi-x-circle"></i>
          </button>
        </div>
        <div class="modal-body">
          <p class="pt-3">Are you sure you want to delete this Inspiration Video ?</p>
        </div>
...
$(document).on('click','.deleteInspirationVideo',function(e){
    var id = $(this).data('id');
    $('.deleteUrl').attr('href','{{route("inspirations.delete_video", ["id" => ""]) }}'+id);
})
...
$(document).on('click','.edit',function(e){
    ...
    $.ajax({
        type : 'POST',
        url  : "{{(route('inspirations.edit_video'))}}",
        ...
        success: function(data){
            ...
            $('#update_form').validate({
                ...
                messages: {
                    'name': {
                        required: "Please Enter English Prayer Name"
                    },
                    'korean_name': {
                        required: "Please Enter Korean Prayer Name"
                    },
                    'spanish_name': {
                        required: "Please Enter Spanish Prayer Name"
                    },
                    'portuguese_name': {
                        required: "Please Enter Portuguese Prayer Name"
                    },
                    'filipino_name': {
                        required: "Please Enter Filipino Prayer Name"
                    },
                    'video': {
                        required: "Please Enter English Video Link"
                    },
