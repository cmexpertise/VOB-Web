...
<section class="section">
    <div class="text-end">
        <button type="button" id="click-btn" class="btn btn-primary">Add Quote Category</button>
    </div>
    <div class="form-slide">
        <div class="d-flex justify-content-between mt-5"><h2>Quote Category Form</h2>
        ...
        <div class="row edit_form"> 
            ...
            <form class="add_form" name="add_form" method="POST" id="add_form" novalidate action="{{route('quotes.add')}}" enctype="multipart/form-data">
                @csrf
                <div class="row g-3">
                    <div class="row g-3">
                        <div class="col-md-2">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Delete Quote Category</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
            <i class="bi bi-x-circle"></i>
          </button>
        </div>
        <div class="modal-body">
          <p class="pt-3">Are you sure you want to delete this Quote Category ?</p>
        </div>
...
$(document).on('click','.deleteQuoteCategory',function(e){
    var id = $(this).data('id');
    $('.deleteUrl').attr('href','{{route("quotes.delete", ["id" => ""]) }}'+id);
})
