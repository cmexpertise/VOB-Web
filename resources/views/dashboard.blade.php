      ...
      <div class="row">
          ...
          <div class="card info-card customers-card">
            ...
            <div class="card-body">
              ...
              <div class="d-flex align-items-center">
                <a href="{{route('user.analytics')}}" class="card-icon rounded-circle d-flex align-items-center justify-content-center">
        ...
        <div class="col-xxl-2 col-md-6">
          <div class="card info-card customers-card">
            ...
            <div class="card-body">
              <h5 class="card-title">Books <span></span></h5>
              <div class="d-flex align-items-center">
                <a href="{{route('books')}}" class="card-icon rounded-circle d-flex align-items-center justify-content-center">
        ...
        <div class="col-xxl-2 col-md-6">
          <div class="card info-card revenue-card">
            ...
            <div class="card-body">
              <h5 class="card-title">Videos <span></span></h5>

              <div class="d-flex align-items-center">
                <a href="{{route('chapters')}}" class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                  <i class="bx  ri-video-chat-line"></i>
                </a>
                <div class="ps-3">
                  <h6>{{$video}}</h6>
        ...
        <div class="col-xxl-2 col-md-6">
          <div class="card info-card revenue-card">
            ...
            <div class="card-body">
              <h5 class="card-title">Audios <span></span></h5>

              <div class="d-flex align-items-center">
                <a href="{{route('chapters')}}" class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                  <i class="ri ri-file-music-line"></i>
                </a>
                <div class="ps-3">
                  <h6>{{$audio}}</h6>
                  {{-- <span class="text-success small pt-1 fw-bold">8%</span> <span class="text-muted small pt-2 ps-1">increase</span> --}}
        ...
        <div class="col-xxl-2 col-md-6">
          <div class="card info-card sales-card">
            ...
            <div class="card-body">
              <h5 class="card-title">Quotes <span></span></h5>

              <div class="d-flex align-items-center">
                <a href="{{route('quotes')}}" class="card-icon rounded-circle d-flex align-items-center justify-content-center">
        ...
        <div class="col-xxl-2 col-md-6">
          <div class="card info-card sales-card">
            ...
            <div class="card-body">
              <h5 class="card-title">Travel Samaritans <span></span></h5>

              <div class="d-flex align-items-center">
                <a href="{{route('travel_samaritans')}}" class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                  <i class="bx  ri-video-chat-line"></i>
                </a>
                <div class="ps-3">
                  <h6>{{$travel_samaritan}}</h6>
                  {{-- <span class="text-success small pt-1 fw-bold">8%</span> <span class="text-muted small pt-2 ps-1">increase</span> --}}
        ...
        <div class="col-xxl-2 col-xl-12">
          <div class="card info-card customers-card">
            <div class="card-body">
              <h5 class="card-title">Broadcasts <span></span></h5>
              <div class="d-flex align-items-center">
                <a href="{{route('daily_prayer')}}" class="card-icon rounded-circle d-flex align-items-center justify-content-center">
        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <input type="hidden" id="monthlySubscription" value='{{json_encode($monthwise_array_sbscr);}}'>
              <!-- Line Chart -->
              ...
              echarts.init(document.querySelector("#trafficChart")).setOption({
                ...
                series: [{
                  ...
                  data: [{
                    ...
                    {
                      value: {{json_encode($audio)}},
                      name: 'Audios'
                    },
                    {
                      value: {{json_encode($quote)}},
                      name: 'Quotes'
                    },
                    {
                      value: {{json_encode($travel_samaritan)}},
                      name: 'Travel Samaritans'
                    },
                    {
                      value: {{json_encode($inspiration)}},
                      name: 'Inspiration Videos'
                    },
                    {
                      value: {{json_encode($night_story)}},
                      name: 'Night Time Story Videos'
                    },
                    {
