...
@php
  ...
  if($language == 'ko'){
    $audio = $chapters[0]->korean_audio;
  }elseif ($language == 'tl') {
    $audio = $chapters[0]->filipino_audio;
  }elseif ($language == 'pt') {
    $audio = $chapters[0]->portuguese_audio;
  }elseif ($language == 'es') {
    $audio = $chapters[0]->spanish_audio;
  }else {
...
<section class="audio-wrapper">
    <div class="container">
        ...
        <div class="row">
            ...
            @php
              if($language == 'ko'){
                $chapter_audio = $chapter->korean_audio;
              }elseif ($language == 'tl') {
                $chapter_audio = $chapter->filipino_audio;
              }elseif ($language == 'pt') {
                $chapter_audio = $chapter->portuguese_audio;
              }elseif ($language == 'es') {
                $chapter_audio = $chapter->spanish_audio;
              }else {
