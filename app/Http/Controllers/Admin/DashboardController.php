...
class DashboardController extends Controller
{
    ...
    public function index(){
        ...
        $broadcasts = Daily_prayer::count();
        $header = 'Dashboard';
        return view('dashboard',compact('users','subscribers','broadcasts','recently_added','night_story','travel_samaritan','inspiration','header','book','video','audio','quote','monthwise_array','monthwise_array_sbscr'));
    }
