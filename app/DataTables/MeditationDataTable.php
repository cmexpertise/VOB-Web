...
class MeditationDataTable extends DataTable
{
    /**
     ...
     *
     * @param \App\Models\Meditation $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(Meditation $model)
    {
        return Meditation::select('id','name','korean_name','spanish_name','portuguese_name','filipino_name','image')
        ->orderBy('id','DESC');
    }
    ...
    {
        return 'Meditation_' . date('YmdHis');
    }
}
