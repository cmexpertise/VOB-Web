...
use App\Models\NightTimeStoryVideo;
...
class NightTimeStoryVideoDataTable extends DataTable
{
    /**
     ...
     *
     * @param \App\Models\NightTimeStoryVideo $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(Request $request,Night_time_story_video $model)
    {
        $id = decrypt($request->id);
        return Night_time_story_video::select('id','name','video','image')
            ->where('night_time_story_id',$id)
            ->orderBy('id','DESC');
    }
    ...
    {
        return $this->builder()
                    ->setTableId('nighttimestoryvideo-table')
    ...
    {
        return 'NightTimeStoryVideo_' . date('YmdHis');
    }
}
